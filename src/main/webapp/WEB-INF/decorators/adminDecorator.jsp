...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="assets/plugins/bootstrap-paginator/css/bootstrap-responsive.min.css">
			...
			<div class="container">
				...
				<div class="navbar-tools">
					...
					<ul class="nav navbar-right">
						<!-- start: USER DROPDOWN -->
						<li class="dropdown current-user"><a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#"><i class="clip-user-3 "></i>
