...
<!--[if gte IE 9]>
		...
		<script type="text/javascript">
			function checkfrom(form) {
				...
				$.ajax({
					type: "post",
					url: "./${sessionScope.pathCode}/updateStuPsd.do",
					data: "psw=" + pwd2,
					dataType: 'html',
			...
			<div class="container">
				...
				<div class="navbar-tools">
					...
					<ul class="nav navbar-right">
						...
						<!-- start: USER DROPDOWN -->
						<li class="dropdown current-user">
							<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="javascript:void(0)"><i class="clip-user-3 "></i> <span class="username">${sessionScope.user.name }</span>
								<i class="clip-chevron-down"></i> </a>
							<ul class="dropdown-menu">
								<li>
									<a href="./${sessionScope.pathCode}/myInfo.do">
								...
								<li>
									<a href="./logout.do"> <i class="glyphicon glyphicon-log-out"></i> &nbsp;退出
									</a>
								</li>
							</ul>
						</li>
